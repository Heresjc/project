...
<div id="tabdemo">
    ...
    <div rel="tab-3" class="content">
        <div class="vdoSubtitle">
            <div class="vdoSubtle" id="demo">
                <div id="lyricContainer" style="font-size: 20px;font-family: Arial,'Times New Roman',Serif;color: #a5a5a5;height:200px;overflow:hidden;border:1px solid #ccc;"></div>
                <div id="demo2"></div>
