...
<div id="tabdemo">
    ...
    <div rel="tab-3" class="content">
        ...
        <div class="vdoSub row">
        	  
        	  <div class="col-xs-7" style="float:left;padding-right:0px;line-height:40px">
        	  	<span style="display: inline-block;padding: 0 10px;">Speed:</span>
        	  	<span style="display: inline-block;margin:0 10px;padding: 2px 10px;border: 2px solid #ccc;border-radius: 100%;">常</span>
        	  	<span style="display: inline-block;margin:0 10px;padding: 2px 10px;border: 2px solid #ccc;border-radius: 100%;">快</span>
        	  </div>
